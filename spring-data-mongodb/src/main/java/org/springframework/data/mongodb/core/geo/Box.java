...
public class Box extends org.springframework.data.geo.Box implements Shape {
	...
	public List<? extends Object> asList() {
		...
		list.add(org.springframework.data.mongodb.core.geo.Point.asList(getLowerLeft()));
		list.add(org.springframework.data.mongodb.core.geo.Point.asList(getUpperRight()));
